...
However, more choice does not mean lower standards. In fact, I intend to enforce much tighter security and quality controls on [affiliates](affiliates/i.md) than most companies enforce on their own staff. While affiliates will remain independent, their work will be subject to source-code review, reproducible testing, security scrutiny, and clear accountability.
